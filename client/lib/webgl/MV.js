...
rotate = function rotate( angle, axis )
{
...
lookAt = function lookAt( eye, at, up )
{
...
normalize = function normalize( u, excludeLastComponent )
{
...
normalMatrix = function normalMatrix(m, flag)
{
    var a = mat4();
